$(document).ready(function(){
	...
	$(document).on('click', '.dev_uid_up', function(){
		...
		var confirmation = confirm("Do you really want to Update this Device Token?");
		if (confirmation) {
		// AJAX Request
		$.ajax({
			url: 'dev_config.php',
	...
	$(document).on('click', '.dev_del', function(){
		...
		var confirmation = confirm("Do you really want to delete this Device?");
		if (confirmation) {
		// AJAX Request
		$.ajax({
			url: 'dev_config.php',
	...
	$(document).on('click', '.mode_sel', function(){
		...
		var confirmation = confirm("Do you really want to change this Device Mode?");
		if (confirmation) {
		  // AJAX Request
		  $.ajax({
			url: 'dev_config.php',
